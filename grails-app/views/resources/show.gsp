...
<html>
    ...
    <body>
        ...
        <div id="show-resources" class="content scaffold-show" role="main">
            ...
            <f:display bean="resources" />
            <g:form resource="${this.resources}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.resources}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
